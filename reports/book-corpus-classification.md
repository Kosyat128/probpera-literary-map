...
- Всего карточек в архиве: 10053.
- Draft-карточек в редакционной очереди: 9777.
- Reviewed/verified-карточек, которые не проходят полный publication gate: 248.
- Всего непубличных карточек, требующих обогащения: 10025.
- Raw draft ID, включая скрытые текущей дедупликацией: 9780.
- Всего target ID в manifest (draft + непубличные editorial): 10028.
