...
- Bio с упоминанием Nobel: 109; с явным годом: 106; без года: 3; неверных годов: 0.
- Официальных карточек без Nobel в bio: 16. Это допустимо: архив использует metadata.
