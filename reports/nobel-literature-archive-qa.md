...
- Bio с упоминанием Nobel: 105; с явным годом: 101; без года: 4; неверных годов: 0.
- Официальных карточек без Nobel в bio: 20. Это допустимо: архив использует metadata.
...
| --- | --- | --- |
| `france:sully_prudhomme` | Рене Франсуа Арман Сюлли-Прюдом | 1901 |
