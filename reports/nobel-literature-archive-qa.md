...
- Bio с упоминанием Nobel: 124; с явным годом: 119; без года: 5; неверных годов: 0.
- Официальных карточек без Nobel в bio: 1. Это допустимо: архив использует metadata.
...
| --- | --- | --- |
| `austria:elfriede_jelinek` | Эльфрида Елинек | 2004 |
| `austria:peter_handke` | Петер Хандке | 2019 |
| `belgium:maurice_maeterlinck` | Морис Метерлинк | 1911 |
| `egypt:naguib_mahfouz` | Нагиб Махфуз | 1988 |
