...
- Bio с упоминанием Nobel: 98; с явным годом: 94; без года: 4; неверных годов: 0.
- Официальных карточек без Nobel в bio: 27. Это допустимо: архив использует metadata.
