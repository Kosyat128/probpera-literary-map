...
- Bio с упоминанием Nobel: 110; с явным годом: 107; без года: 3; неверных годов: 0.
- Официальных карточек без Nobel в bio: 15. Это допустимо: архив использует metadata.
