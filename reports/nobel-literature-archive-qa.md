...
- Bio с упоминанием Nobel: 108; с явным годом: 105; без года: 3; неверных годов: 0.
- Официальных карточек без Nobel в bio: 17. Это допустимо: архив использует metadata.
