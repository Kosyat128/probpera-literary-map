...
const generatedWithdrawals = path.join(
  projectRoot,
  "src",
  "data",
  "articles",
...
function asGeneratedWithdrawalsModule(value) {
  return `// Generated by scripts/export-published-content.mjs. Do not edit by hand.\n// Verified CMS withdrawals that suppress retired static article fallbacks.\nexport const cmsWithdrawnLegacyArticles = ${JSON.stringify(value, null, 2)} as const;\n`;
}
...
const withdrawnLegacyArticles = normalizeLegacyArticleWithdrawals(
  publishedContent.withdrawnLegacyArticles
);
const changed = [];
...
const normalizedPublishedContent = {
  ...publishedContent,
  articles,
...
const outputs = [
  ...
  [generatedWithdrawals, asGeneratedWithdrawalsModule(withdrawnLegacyArticles)],
];
