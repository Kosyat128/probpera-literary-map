...
const summary = {
  ...
  russianBiographiesReady: editorial.russianBiographiesReady,
  russianBiographiesVerified: editorial.russianBiographiesVerified,
  russianBiographiesWithheld: editorial.russianBiographiesWithheld,
  englishBiographiesReady: editorial.englishBiographiesReady,
  englishBiographiesReviewed: editorial.englishBiographiesReviewed,
  englishBiographiesVerified: editorial.englishBiographiesVerified,
  englishBiographiesWithheld: editorial.englishBiographiesWithheld,
...
await writeFile(
  ...
  [
    ...
    `- Карточек писателей со старым общим editorial-статусом verified: ${summary.verifiedWriters}`,
    `- Старых расширенных текстов (не равны допуску к публикации): ${summary.expandedBiographies}`,
    `- Русских биографий, прошедших отдельный quality/legal gate: ${summary.russianBiographiesReady}`,
    `- Русских биографий со строгим статусом verified: ${summary.russianBiographiesVerified}`,
    `- Русских биографий, скрытых до проверки: ${summary.russianBiographiesWithheld}`,
    `- Английских биографий, прошедших gate: ${summary.englishBiographiesReady}`,
    `- Английских биографий со статусом reviewed: ${summary.englishBiographiesReviewed}; verified: ${summary.englishBiographiesVerified}`,
    `- Английских биографий, скрытых до проверки: ${summary.englishBiographiesWithheld}`,
