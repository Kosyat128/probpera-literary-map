export const dostoevskyProfile = {
  ...
  portrait:"/images/writers/dostoevsky.jpg",
  movement:"Реализм",
  century:"XIX век",
  language:"Русский",
  nobel:false,
  profession:["Писатель","Мыслитель","Публицист"],
  biography:"Русский писатель, мыслитель и один из крупнейших авторов мировой литературы. Исследовал нравственные, философские и психологические проблемы человека.",
