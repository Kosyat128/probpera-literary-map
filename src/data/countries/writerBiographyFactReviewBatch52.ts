...
const seeds: readonly ReviewSeed[] = [
  ...
  },
  {
    ...
    reviewedTextRu: "Ханна Мина (1924–2018) — сирийский романист, родившийся в Латакии. В его прозе заметное место занимают море, моряки и социальная история Сирии.",
    evidence: [
      e("Banipal", "https://www.banipal.co.uk/contributors/1215/hanna-mina-1924%E2%80%932018/", "Профиль указывает годы 1924–2018, Латакию и устойчивую морскую тематику романов Мины."),
      e("Larousse", "https://www.larousse.fr/encyclopedie/litterature/Hanna_Mina/175358", "Литературная энциклопедия подтверждает личность сирийского романиста и основные сведения о его творчестве."),
    ],
    decision: "corrected",
    notes: "Убрана трудно измеримая формула об «основателе» романа; оставлены биографические и тематические факты, подтверждённые двумя справочными источниками.",
  },
  {
  ...
  },
  {
    ...
    reviewedTextRu: "У Минъи (род. 1971) — тайваньский романист и преподаватель литературы; экологические темы занимают заметное место в его прозе. Среди его книг — «Человек с фасеточными глазами» и «Похищенный велосипед».",
    evidence: [
      e("Books from Taiwan", "https://booksfromtaiwan.moc.gov.tw/authors_info.php?id=68", "Портал подтверждает 1971 год рождения, литературную деятельность и библиографию У Минъи."),
      e("National Dong Hwa University", "https://sys.ndhu.edu.tw/RD/TeacherTreasury/TcherData/research.aspx?tcher=10129", "Университетский профиль подтверждает преподавательскую должность и публикации автора, включая экологически ориентированные работы."),
    ],
    decision: "corrected",
    notes: "Нейтральная справка дополнена проверяемыми названиями произведений и академической деятельностью.",
  },
  {
  ...
  },
  {
    ...
    reviewedTextRu: "Видиадхар Сураджпрасад Найпол (1932–2018) — родившийся в Тринидаде британский романист и автор документальной прозы. Он получил Букеровскую премию за «В свободном государстве» в 1971 году и Нобелевскую премию по литературе в 2001 году.",
    evidence: [
