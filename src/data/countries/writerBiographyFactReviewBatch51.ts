...
const seeds: readonly ReviewSeed[] = [
  ...
  },
  {
    ...
    reviewedTextRu: "Эрик Аксель Карлфельдт (1864-1931) - шведский поэт, на протяжении многих лет занимавший должность постоянного секретаря Шведской академии. В 1931 году Нобелевская премия по литературе была присуждена ему посмертно.",
    evidence: [
  ...
  },
  {
    ...
    reviewedTextRu: "Тумас Транстрёмер (1931-2015) - шведский поэт и психолог. Его литературным дебютом стал вышедший в 1954 году сборник «17 стихотворений»; в 2011 году ему присудили Нобелевскую премию по литературе.",
    evidence: [
      ...
      e("Nordic Council", "https://www.norden.org/sv/nominee/1990-tomas-transtromer-sverige-levande-och-doda", "Официальный ресурс Северного совета независимо подтверждает, что Транстрёмер дебютировал в 1954 году сборником 17 dikter, а также фиксирует его поэтическую деятельность и Нобелевскую премию 2011 года."),
    ],
    decision: "corrected",
