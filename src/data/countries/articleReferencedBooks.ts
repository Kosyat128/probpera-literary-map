...
const articleReferencedWriters: Record<string, WriterProfile[]> = {
  ...
  france: [
    {
      ...
      workDetails: [
        ...
        articleWork(
          "la-tendresse",
          "Нежность",
          "https://probpera.ru/stati/o-literature/sem-maloizvestnyh-rasskazov-imenityh-pisateley-kotorye-sleduet-prochitat-kazhdomu-anri-barbyus/",
          {
            alternateTitles: ["Affection"],
            originalTitle: "La Tendresse",
            firstPublished: 1913,
            originalLanguage: "французский",
            genres: ["рассказ", "эпистолярная проза"],
            tags: ["письма", "разлука", "память"],
            description:
              "Эпистолярный рассказ построен как пять писем женщины к Луи, доставляемых через всё большие промежутки после их разрыва. Смена интонаций и заключительное письмо заставляют заново понять историю разлуки, не превращая её в обычную хронику угасающего чувства.",
            sources: [
              {
                provider: "Проба Пера",
                ...
                recordId: "cms-42fc788d-5d3b-41d2-9c68-f74effdd6ace",
                url: "https://probpera.ru/stati/o-literature/sem-maloizvestnyh-rasskazov-imenityh-pisateley-kotorye-sleduet-prochitat-kazhdomu-anri-barbyus/",
                fields: ["identity", "title", "description"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
                provider: "Bibliothèque nationale de France - Gallica",
                authorityId: "bnf",
                authorityTier: "A",
                country: "france",
                language: "French",
                recordKind: "authoritative-work-page",
                recordId: "ARK-bpt6k570479r-f4",
                url: "https://gallica.bnf.fr/ark:/12148/bpt6k570479r/f4.item",
                fields: [
                  "identity",
                  "authorship",
                  "title",
              ...
              },
              {
                ...
                recordId: "FRBNF31761582",
                url: "https://catalogue.bnf.fr/ark:/12148/cb31761582r",
              ...
              },
              {
                ...
                language: "English",
                recordKind: "national-bibliography",
                recordId: "FRBNF32913340",
                url: "https://catalogue.bnf.fr/ark:/12148/cb329133406",
                fields: ["identity", "title", "publication-year", "language"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
                provider: "Trieste Publishing",
                authorityId: "trieste-publishing",
                authorityTier: "B",
                country: "australia",
                market: "AU",
                language: "English",
                recordKind: "publisher-catalog",
                recordId: "ISBN-9780649252787",
                url: "https://trieste-publishing.com/books/we-others-stories-of-fate-love-and-pity-9780649252787",
                fields: ["identity", "title", "publication-year", "language", "market"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
                provider: "Николаевская областная универсальная научная библиотека",
                authorityId: "mykolaiv-regional-library",
                authorityTier: "B",
                country: "ukraine",
                market: "UA",
                language: "Russian",
                recordKind: "structured-dataset",
                recordId: "ISBN-5-88195-048-8",
                url: "https://opac.mk.ua/cgi-bin/irbis64r_11/cgiirbis_64.exe?C21COM=S&FT_PREFIX=&FT_REQUEST=&I21DBN=ELKAT&LNG=&P21DBN=ELKAT&S21ALL=%28%3C.%3ES%3D%D0%9B%D1%8E%D0%B1%D0%BE%D0%B2%D0%BD%D1%96+%D1%80%D0%BE%D0%BC%D0%B0%D0%BD%D0%B8%3C.%3E%29&S21CNR=1010&S21FMT=infow_wh&S21REF=5&S21SRD=&S21SRW=&S21STN=1&Z21ID=",
                fields: ["identity", "title", "publication-year", "language", "market"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
            ...
            externalIds: [
              {
                scheme: "other",
                value: "FRBNF31761582",
                sourceUrl: "https://catalogue.bnf.fr/ark:/12148/cb31761582r",
              },
              {
                scheme: "other",
                value: "FRBNF32913340",
                sourceUrl: "https://catalogue.bnf.fr/ark:/12148/cb329133406",
              },
            ],
          }
        ),
  ...
  russia: [
    {
      ...
      workDetails: [
        articleWork(
          ...
          {
            alternateTitles: ["The Village"],
            originalTitle: "Деревня",
            firstPublished: 1910,
            originalLanguage: "русский",
            genres: ["повесть", "реализм"],
            tags: ["деревня", "Дурновка", "начало XX века"],
            description:
              "Повесть показывает Дурновку на фоне общественных потрясений начала XX века через судьбы братьев Тихона и Кузьмы Красовых. Их разные жизненные пути и взгляды сходятся в суровом изображении бедности, насилия и неподвижного деревенского уклада.",
            sources: [
              {
                provider: "Проба Пера",
                authorityId: "probpera-editorial",
              ...
              },
              {
                ...
                fields: ["identity", "authorship", "title", "publication-year", "language", "market"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
            ...
            externalIds: [
              {
                scheme: "other",
                value: "RSL-01003796448",
                sourceUrl: "https://search.rsl.ru/ru/record/01003796448",
              },
              {
                scheme: "other",
                value: "LCCN-23009538",
  ...
  usa: [
    ...
    },
    {
      ...
      works: ["Парк юрского периода", "Затерянный мир"],
      workDetails: [
        ...
        articleWork(
          "the-lost-world",
          "Затерянный мир",
          "https://probpera.ru/stati/knizhnyy-gid/desyat-romanov-kotorye-chitayutsya-na-odnom-dyhanii/",
          {
            alternateTitles: ["The Lost World"],
            originalTitle: "The Lost World",
            firstPublished: 1995,
            originalLanguage: "английский",
            genres: ["научная фантастика", "технотриллер"],
            tags: ["динозавры", "экспедиция", "остров"],
            description:
              "Через шесть лет после катастрофы в Парке юрского периода сообщения о выживших динозаврах приводят Иэна Малкольма и исследовательскую группу на второй остров у побережья Коста-Рики. Там им приходится противостоять не только хищникам, но и соперникам, стремящимся завладеть результатами генетических экспериментов.",
            sources: [
              {
                provider: "Проба Пера",
                authorityId: "probpera-editorial",
                ...
                language: "Russian",
                recordKind: "article-source",
                recordId: "cms-a842e019-25b3-464b-a084-64cb6a5357cf",
                url: "https://probpera.ru/stati/knizhnyy-gid/desyat-romanov-kotorye-chitayutsya-na-odnom-dyhanii/",
                fields: ["identity", "title", "description"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
                provider: "Michael Crichton official site",
                authorityId: "michael-crichton-estate",
                authorityTier: "A",
                country: "usa",
                language: "English",
                recordKind: "author-estate",
                recordId: "MC-WORK-THE-LOST-WORLD",
                url: "https://michaelcrichton.com/works/the-lost-world/",
                fields: [
                  "identity",
                  "authorship",
                  "title",
              ...
              },
              {
                ...
                language: "English",
                recordKind: "publisher-catalog",
                recordId: "ISBN-9780345538994",
                url: "https://www.penguinrandomhouse.com/books/33524/the-lost-world-by-michael-crichton/",
                fields: ["identity", "authorship", "title", "publication-year", "language", "description", "market"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
                provider: "CiNii Books",
                authorityId: "cinii-books",
                authorityTier: "A",
                country: "japan",
                market: "US",
                language: "English",
                recordKind: "structured-dataset",
                recordId: "NCID-BA26250459",
                url: "https://ci.nii.ac.jp/ncid/BA26250459",
                fields: ["identity", "authorship", "title", "publication-year", "language", "market"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
              {
                ...
                language: "Russian",
                recordKind: "publisher-catalog",
                recordId: "ISBN-9785699800599",
                url: "https://eksmo.ru/book/zateryannyy-mir-ITD604693/",
                fields: ["identity", "authorship", "title", "original-title", "publication-year", "language", "market"],
                usage: "reference-only",
                retrievedAt: "2026-09-02",
              },
            ],
            externalIds: [
              {
                scheme: "isbn-13",
                value: "9780345538994",
                sourceUrl: "https://www.penguinrandomhouse.com/books/33524/the-lost-world-by-michael-crichton/",
              },
              {
                scheme: "isbn-13",
                value: "9785699800599",
                sourceUrl: "https://eksmo.ru/book/zateryannyy-mir-ITD604693/",
              },
            ],
          }
        ),
