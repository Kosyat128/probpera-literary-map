...
const inputs: readonly ReviewInput[] = [
  ...
  },
  {
    ...
    reviewedTextRu: "Элиас Канетти (1905-1994) - немецкоязычный писатель и эссеист сефардского происхождения. Он написал роман «Ослепление» и исследование «Масса и власть», а в 1981 году получил Нобелевскую премию по литературе.",
    sourceKey: "canetti",
    claims: [
