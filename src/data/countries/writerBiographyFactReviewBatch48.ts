export const WRITER_BIOGRAPHY_FACT_REVIEW_BATCH48_REVIEWER =
  "Codex independent claim-by-claim factual review, batch 48";
...
const reviewer = WRITER_BIOGRAPHY_FACT_REVIEW_BATCH48_REVIEWER;
...
const seeds: readonly ReviewSeed[] = [
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Исходная справка конкретизирована ролью филолога и проверяемым изданием словаря.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Субъективное описание тематики заменено документированными происхождением, академической должностью и произведениями.",
  },
  {
    key: "sierra_leone:augustine_bangura",
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Неподтверждённые год и место рождения удалены. Оставлены только роли, происхождение, произведение и документированная премия.",
  },
  {
    ...
    decision: "corrected",
    notes: "Субъективные оценки удалены; оставлены жанры, произведение и проверяемая премия.",
  },
  {
    ...
    decision: "corrected",
    notes: "Ошибочный год смерти 1996 исправлен на 2003; общее утверждение заменено занятиями и двумя изданиями.",
  },
  {
    ...
    decision: "corrected",
    notes: "Неподтверждённые год и искусственная точная дата 1967-01-01 удалены; оставлены профессии и произведения.",
  },
  {
    ...
    decision: "corrected",
    notes: "Утверждение «первый поэт-лауреат Сингапура» удалено: университетский источник называет Тамбу неофициальным, а не официальным поэтом-лауреатом.",
  },
  {
    ...
    decision: "corrected",
    notes: "Неподтверждённые год и искусственная точная дата 1951-01-01 удалены; добавлены документированные специализация, книга и премия.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Общее определение «современный писатель» заменено академической работой, конкретным романом и премией.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Субъективная оценка значения заменена происхождением, биографическим фактом и конкретным произведением.",
  },
  {
    ...
    decision: "corrected",
    notes: "Оценочное ранжирование заменено жанрами, произведениями и проверяемым числом национальных премий.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Исходная справка уточнена литературными направлениями и проверяемым фактом посмертной публикации.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Исходное утверждение об авторстве «Аламута» сохранено и дополнено документированными занятиями и годом издания.",
  },
  {
    ...
    decision: "corrected",
    notes: "Ошибочный год рождения 1947 исправлен на 1945, добавлен подтверждённый год и день смерти; литературное первенство сформулировано точно.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Субъективное обозначение «величайший» удалено; сохранены псевдоним, жанры, произведения и премия.",
  },
  {
    ...
    decision: "corrected",
    notes: "Субъективное ранжирование удалено; добавлены жанры, язык, произведения и документированная премия.",
  },
  {
    ...
    decision: "corrected",
    notes: "Расплывчатая характеристика религиозно-патриотических произведений заменена документированными ролями и историей публикации стихов. Интервал лет жизни и год смерти очищены из-за расхождения 1920/1921 в академических изданиях.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Общее утверждение конкретизировано жанром, политической деятельностью и тремя произведениями.",
  },
];

export const writerBiographyFactReviewBatch48: readonly WriterBiographyFactReviewRecord[] = seeds.map(
  (seed) => {
