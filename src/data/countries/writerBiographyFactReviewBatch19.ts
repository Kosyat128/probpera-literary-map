export const WRITER_BIOGRAPHY_FACT_REVIEW_BATCH19_REVIEWER =
  "Codex independent claim-by-claim factual review, batch 19";
...
const reviewer = WRITER_BIOGRAPHY_FACT_REVIEW_BATCH19_REVIEWER;
const checkedAt = "2026-08-09";

type ReviewBase = Omit<WriterBiographyFactReviewRecord, "applicableTextRu">;

const writerBiographyFactReviewBatch19Base = [
  {
    key: "china:zhang_a_ling",
    originalSha256: "8648dbb9b55dd8f6d9d04de6c2ef18c74e4ec9198c3c664959e5806a8f76da41",
    reviewedTextRu: "Китайская романистка, эссеистка и сценаристка Чжан Айлин, публиковавшаяся по-английски как Эйлин Чан. Автор повести «Love in a Fallen City» и романов «The Rice-Sprout Song» и «Naked Earth».",
    claims: [{
    ...
    reviewer,
    decision: "corrected",
    notes: "Недоказательный ранг среди авторов XX века заменён документированными ролями, вариантом имени и тремя произведениями. Shared birthDate и deathDate подтверждены; shared country files не изменялись.",
  },
  {
    key: "china:zhang_ling",
    ...
    reviewer,
    decision: "corrected",
    notes: "Place recommendation: заменить shared birthPlace Shanghai на Hangzhou, Zhejiang; это прямо указывает издатель. Неопределённая формула о диаспорной литературе заменена биографическими фактами и двумя романами. Shared country files не изменялись.",
  },
  {
    key: "china:zhuangzi",
  ...
  },
  {
    ...
    reviewer,
    decision: "corrected",
    notes: "Суперлатив о месте в литературе снят; сохранены проверяемые роли и добавлены персонаж, цикл и премия. Shared country files не изменялись.",
  },
  {
    key: "colombia:andres_caicedo",
    originalSha256: "300c998dec6bbe86015883e89952f9bc6f50b031189b52606d5758bce6b8a065",
    reviewedTextRu: "Колумбийский писатель, драматург и кинокритик Андрес Кайседо участвовал в создании киноклуба Кали и журнала «Ojo al Cine». Автор романа «¡Que viva la música!» и повести «El atravesado».",
    claims: [{
    ...
    reviewer,
    decision: "corrected",
    notes: "Оценочная формула «культовая фигура» и широкая тематическая интерпретация заменены организациями и двумя произведениями. Shared country files не изменялись.",
  },
  {
    ...
    claims: [{
      ...
      verdict: "corrected",
      evidence: [
        { provider: "Centro Virtual Cervantes", url: "https://cvc.cervantes.es/el_rinconete/anteriores/abril_04/29042004_02.htm", checkedAt, findingRu: "Материал Института Сервантеса подтверждает рождение Вальехо в Медельине, его литературную и кинематографическую работу и роман La Virgen de los sicarios." },
        { provider: "Penguin Libros", url: "https://www.penguinlibros.com/co/15380-fernando-vallejo", checkedAt, findingRu: "Издательская биография подтверждает роли автора, оба романа и присуждение El desbarrancadero премии Ромуло Гальегоса в 2003 году." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Общая интерпретация тем заменена местом рождения, двумя романами и документированной премией. Формулировка не приписывает автору неизменную современную национальность. Shared country files не изменялись.",
  },
  {
    key: "colombia:gabriel_garcia_marquez",
    originalSha256: "50f4a1cce1ba589351917d766fd3c74b64d7a04e32798132600bef30f99d6591",
    reviewedTextRu: "Колумбийский писатель и журналист Габриэль Гарсиа Маркес, лауреат Нобелевской премии по литературе 1982 года. Автор романов «Cien años de soledad» и «El amor en los tiempos del cólera».",
    claims: [{
      textRu: "Габриэль Гарсиа Маркес был колумбийским писателем и журналистом, получил Нобелевскую премию по литературе 1982 года и написал Cien años de soledad и El amor en los tiempos del cólera.",
      verdict: "corrected",
      evidence: [
        { provider: "The Nobel Prize", url: "https://www.nobelprize.org/prizes/literature/1982/marquez/facts/", checkedAt, findingRu: "Официальная нобелевская справка подтверждает гражданство, писательскую и журналистскую деятельность, премию 1982 года и основные произведения Гарсиа Маркеса." },
        { provider: "Fundación Gabo", url: "https://fundaciongabo.org/es/comunidad/perfil/gabriel-garcia-marquez", checkedAt, findingRu: "Фонд, продолжающий журналистское наследие автора, независимо подтверждает его колумбийскую идентичность, журналистику, Нобелевскую премию и библиографию." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Суперлативы и недоказательная формула о главном представителе направления сняты; сохранены Нобелевская премия и два романа. Shared country files не изменялись.",
  },
  {
    ...
    reviewer,
    decision: "corrected",
    notes: "Широкая тематическая формула заменена жанром и тремя библиографически подтверждёнными книгами. Shared birthDate и deathDate подтверждены; shared country files не изменялись.",
  },
  {
    key: "colombia:hector_abad_faciolince",
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "Penguin Libros", url: "https://www.penguinlibros.com/es/literatura-contemporanea/256281-libro-la-oculta-9788466358453", checkedAt, findingRu: "Издательская биография подтверждает эссеистику автора и перечисляет Angosta, El olvido que seremos и La oculta в его библиографии." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Общая тематическая характеристика заменена тремя книгами. Attribution recommendation: приписанное ему в shared works произведение «Мы увидимся в августе» принадлежит Габриэлю Гарсиа Маркесу и должно быть удалено из карточки после отдельной проверки works; shared files не изменялись.",
  },
  {
    key: "colombia:hector_rojas_herazo",
    originalSha256: "dbb3686e0b64788b87690b6eb867724c9dcb77ed0515ab907df5574e7f41436b",
    reviewedTextRu: "Колумбийский поэт, романист, журналист и художник Эктор Рохас Эрасо. Автор романов «Respirando el verano», «En noviembre llega el arzobispo» и «Celia se pudre».",
    claims: [{
      textRu: "Эктор Рохас Эрасо был колумбийским поэтом, романистом, журналистом и художником и написал Respirando el verano, En noviembre llega el arzobispo и Celia se pudre.",
      verdict: "corrected",
      evidence: [
        { provider: "Editorial Universidad del Norte", url: "https://editorial.uninorte.edu.co/simeh/authors/view/id/16", checkedAt, findingRu: "Университетская авторская справка подтверждает четыре творческие роли Рохаса Эрасо, его рождение в Толу и атрибутирует ему три названных романа." },
        { provider: "Universidad Externado de Colombia", url: "https://www.uexternado.edu.co/wp-content/uploads/2017/01/16-antologia-HectorRojasHerazo.pdf", checkedAt, findingRu: "Университетское издание независимо подтверждает поэзию, живопись, журналистику и прозу автора и перечисляет Respirando el verano, En noviembre llega el arzobispo и Celia se pudre." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Date recommendation: заменить shared deathDate 2002-04-19 на 2002-04-11 по биографии Universidad del Norte. Для года рождения встречаются 1920 и 1921; shared 1921-08-12 не изменять без разрешения расхождения. Shared country files не изменялись.",
  },
  {
    key: "colombia:jorge_isaacs",
    originalSha256: "b3fe16f3bb92930ef9aefbdb6c1863f763ebe64890e0fc493a336e77ef086b33",
    reviewedTextRu: "Колумбийский писатель, поэт и политический деятель Хорхе Исаакс. Автор романа «María», впервые опубликованного в 1867 году.",
    claims: [{
    ...
    reviewer,
    decision: "corrected",
    notes: "Оценочная формула о месте романа в романтизме заменена ролями, названием и годом первой публикации. Shared birthDate и deathDate подтверждены; shared country files не изменялись.",
  },
  {
    key: "colombia:juan_carlos_botero",
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "Editorial Planeta", url: "https://www.planetadelibros.com.co/autor/juan-carlos-botero/000039139", checkedAt, findingRu: "Издательская биография независимо подтверждает рождение в Боготе в 1960 году, газетную работу и атрибутирует автору три названные книги." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Общая поколенческая формула заменена полным именем, профессиями и тремя книгами. Shared birthDate 1960-05-01 не подтверждена на уровне дня и месяца: источники указывают только 1960 год. Shared country files не изменялись.",
  },
  {
    key: "colombia:laura_restrepo",
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "Penguin Libros", url: "https://www.penguinlibros.com/us/tematicas/367712-ebook-la-multitud-errante-9788410496613", checkedAt, findingRu: "Издательская биография подтверждает рождение в Боготе в 1950 году, библиографию, включая La multitud errante и Delirio, и премию Alfaguara 2004 года." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Тематическая интерпретация заменена местом и годом рождения, двумя романами и премией. Date recommendation: shared birthDate 1950-01-01 отражает известный год, но день и месяц источниками не установлены; не показывать 1 января как доказанную дату. Shared country files не изменялись.",
  },
  {
    key: "colombia:leon_de_greiff",
    originalSha256: "6dd5e52a50b998f09303a1f0cc13563f05c55f6572046ac82621c265338b3372",
    reviewedTextRu: "Колумбийский поэт Леон де Грейфф, участник групп «Los Panidas» и «Los Nuevos». Автор книг «Tergiversaciones», «Libro de signos» и «Variaciones alrededor de nada».",
    claims: [{
    ...
    reviewer,
    decision: "corrected",
    notes: "Оценочный ранг и широкая формула влияния сняты; добавлены две группы и три книги. Shared dates подтверждены; shared country files не изменялись.",
  },
  {
    key: "colombia:pilar_quintana",
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "Biblioteca de la Universidad Externado de Colombia", url: "https://www.uexternado.edu.co/biblioteca/la-biblioteca-recomienda-leer-sobre-escritorases-colombianos/", checkedAt, findingRu: "Университетская библиотека независимо подтверждает рождение в Кали в 1972 году, обе книги и премию Alfaguara 2021 года за Los abismos." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Общая поколенческая и тематическая формула заменена местом и годом рождения, двумя романами и премией. Exact shared birthDate 1972-04-14 не подтверждена выбранными институциональными источниками; изменения даты не предлагаются. Shared country files не изменялись.",
  },
  {
    key: "colombia:ricardo_silva_romero",
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "Penguin Libros", url: "https://www.penguinlibros.com/co/tematicas/83502-ebook-historia-oficial-del-amor-9789588948201", checkedAt, findingRu: "Издательская биография подтверждает рождение в Боготе в 1975 году и атрибутирует автору Historia oficial del amor и Cómo perderlo todo." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Date recommendation: заменить shared birthDate 1975-02-14 на 1975-08-14; точную дату 14 августа 1975 года указывает университетская биографическая справка Universidad Santo Tomás, тогда как издатель подтверждает год. Недоказательный поколенческий ранг снят. Shared country files не изменялись.",
  },
  {
    key: "colombia:santiago_mutis_duran",
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "Universidad Nacional de Colombia", url: "https://revistas.unal.edu.co/index.php/jardin/article/view/27269", checkedAt, findingRu: "Университетская авторская справка независимо определяет Сантьяго Мутиса Дурана как колумбийского поэта, эссеиста и редактора и фиксирует его издательскую работу." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Общая поколенческая формула заменена местом и годом рождения, ролями и тремя книгами. Exact shared birthDate 1951-03-25 выбранными источниками не подтверждена; изменения даты не предлагаются. Shared country files не изменялись.",
  },
  {
    key: "comoros:mahmoud_said_ahmed",
    originalSha256: "e756043aeeeaa865aafa310544e25d3469c19a5a0e16426c63a63bd873507996",
    reviewedTextRu: "Личность коморского автора «Махмуд Саид Ахмед», якобы родившегося в 1956 году, не установлена по проверенным национальным и университетским каталогам. До появления авторитетной записи или документированной библиографии карточку нельзя использовать как фактическую.",
    claims: [{
      textRu: "Не удалось установить литературную личность Mahmoud Saïd Ahmed как коморского автора 1956 года рождения или найти документированную библиографию, относящуюся к этой карточке.",
    ...
    reviewer,
    decision: "held",
    notes: "Quarantine recommendation: удерживать карточку и не смешивать её с египетским художником Mahmoud Saïd, иракским автором Mahmoud Saeed или коморским историком Mahmoud Ibrahime. Требуется institutional authority record либо произведение с надёжной атрибуцией. Shared country files не изменялись.",
  },
  {
    ...
    claims: [{
      ...
      evidence: [
        ...
        { provider: "University of Nairobi", url: "https://erepository.uonbi.ac.ke/server/api/core/bitstreams/1a972ff5-f647-4f39-9791-4f705e98abdf/content", checkedAt, findingRu: "Университетское исследование подтверждает авторскую идентичность, год рождения 1947, работу в суахилийской литературе и библиографию, включая Asali Chungu, Utengano и Dunia Yao." },
      ],
    }],
    reviewer,
    decision: "corrected",
    notes: "Identity/country/date recommendation: Q16678223 относится к этому танзанийскому, а не коморскому автору; bad-QID flag отклонить, но карточку перенести из Comoros в Tanzania. Заменить shared birthDate 1956 на 1947-12-12 и birthPlace на Zanzibar. Shared country files не изменялись.",
  },
  {
    key: "comoros:salim_hatubou",
    originalSha256: "cf9c333bec99dadfe35921a3c8615612d256283fab9e559b77c7e4651d4ead37",
    reviewedTextRu: "Франко-коморский писатель и сказитель Салим Хатубу, родившийся 20 июня 1972 года в Хахайе на острове Нгазиджа. Автор романов, рассказов и книг для детей, в том числе «Le sang de l’obéissance» и «Contes de ma grand-mère».",
    claims: [{
      textRu: "Салим Хатубу был франко-коморским писателем и сказителем, родился 20 июня 1972 года в Хахайе и написал, среди прочего, Le sang de l’obéissance и Contes de ma grand-mère.",
      verdict: "corrected",
      evidence: [
    ...
    reviewer,
    decision: "corrected",
    notes: "Place recommendation: заменить shared birthPlace Comoros на Hahaya, Ngazidja, Comoros. Shared birthDate 1972-06-20 и deathDate 2015-03-31 подтверждены. Общая формула дополнена ролью сказителя, точным местом рождения и двумя книгами. Shared country files не изменялись.",
  },
...
export const writerBiographyFactReviewBatch19: readonly WriterBiographyFactReviewRecord[] =
  writerBiographyFactReviewBatch19Base.map(finalizeReviewRecord);
