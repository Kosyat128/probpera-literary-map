...
const seeds: readonly WriterSeed[] = [
  {
    ...
    years: "1803-1873",
    bio: "Фёдор Иванович Тютчев (1803-1873) - русский поэт и дипломат, член-корреспондент Петербургской академии наук. К числу его стихотворений относятся «Весенняя гроза», «Цицерон» и «Наш век».",
  ...
  },
  {
    ...
    years: "1870-1938",
    bio: "Александр Иванович Куприн (1870-1938) - русский писатель, переводчик и публицист. Он работал в художественной прозе; к числу его повестей относятся «Олеся», «Поединок» и «Гранатовый браслет».",
