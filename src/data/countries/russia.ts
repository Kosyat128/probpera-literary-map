...
export const russia: Country = {
  ...
  writers: [
    ...
    },
    {
      ...
      portrait: "",
      bio: "Русский писатель, мыслитель и философ, один из величайших романистов мировой литературы.",
      works: [
    ...
    },
    {
      ...
      portrait: "",
      bio: "Русский писатель, мыслитель и общественный деятель, автор произведений, оказавших огромное влияние на мировую литературу.",
      works: [
        "Война и мир",
        "Анна Каренина",
        "Воскресение",
      ...
      portrait: "",
      bio: "Русский писатель, драматург и врач, один из величайших мастеров рассказа и мировой драматургии.",
      works: [
        "Вишнёвый сад",
        "Три сестры",
        "Чайка",
