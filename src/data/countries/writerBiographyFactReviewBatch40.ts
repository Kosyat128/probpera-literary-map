export const WRITER_BIOGRAPHY_FACT_REVIEW_BATCH40_REVIEWER =
  "Codex independent claim-by-claim factual review, batch 40";
...
const reviewer = WRITER_BIOGRAPHY_FACT_REVIEW_BATCH40_REVIEWER;
...
const seeds = [
  {
    ...
    decision: "corrected",
    notes: "Оценочные первенствующие формулы заменены исторической принадлежностью, жанрами и тремя документированными произведениями.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив и неподкреплённое тематическое обобщение заменены языками, тремя книгами и официально подтверждённой стипендией.",
  },
  {
    ...
    decision: "corrected",
    notes: "Имя нормализовано как Юри; ранжирование и широкая тематическая оценка заменены ролями, книгами и проверяемой университетской должностью.",
  },
  {
    ...
    decision: "corrected",
    notes: "Ранжирование заменено жанром, тремя названиями сборников и официально зафиксированной международной наградой.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив удалён; краткая заглушка дополнена жанрами, тремя оригинальными названиями и проверяемой премией.",
  },
  {
    ...
    decision: "corrected",
    notes: "Однострочная заглушка дополнена проверенными ролями, тремя сборниками и редакторской деятельностью.",
  },
  {
    ...
    decision: "corrected",
    notes: "Короткая заглушка дополнена литературоведческой и редакторской ролями и двумя атрибутированными книгами.",
  },
  {
    ...
    decision: "corrected",
    notes: "Профиль дополнен проверенными профессиональными ролями и тремя оригинальными названиями книг о Гугуцэ.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Абстрактная формула заменена двумя датированными вкладами; ошибочный день рождения в структуре исправляется по монегасскому источнику.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив заменён четырьмя проверяемыми ролями, тремя оригинальными названиями и направлением исследований.",
  },
  {
    ...
    decision: "corrected",
    notes: "Ранжирование удалено; профиль дополнен религиозной и музыкальной ролями, театром и точным названием постановки.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Общая заглушка заменена проверяемыми ролями, тематикой, тремя книгами и государственной наградой.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Общая строка дополнена филологией, историей литературы и двумя оригинальными названиями; спорный точный день смерти не публикуется.",
  },
  {
    ...
    decision: "corrected",
    notes: "Общая заглушка дополнена четырьмя жанрами, тремя оригинальными названиями и официально подтверждённой премией.",
  },
  {
    ...
    decision: "corrected",
    notes: "Общее тематическое описание заменено исторической ролью и тремя оригинальными названиями произведений.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Общая роль уточнена периодами правления и оригинальным названием документированного произведения.",
  },
  {
    ...
    decision: "corrected",
    notes: "Неатрибутированное «Детство» заменено двумя подтверждёнными оригинальными названиями и соответствующими премиями.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлативы удалены; профиль опирается на официально подтверждённые роли, период правления и первое издание произведения.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив жанрового мастерства и неустановленный «Канцлер» заменены происхождением и каталогизированными произведениями.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив удалён; профиль дополнен точными жанрами, языковой парой перевода, журналом и официальной премией.",
  },
  {
    ...
    decision: "corrected",
    notes: "Первенствующая формула и неточное название заменены ролями и двумя оригинальными названиями с жанрами.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив заменён языком, профессиональной ролью и тремя оригинальными названиями романов.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив удалён; профиль дополнен университетской работой, предметом исследований и двумя официальными наградами.",
  },
  {
    ...
    decision: "corrected",
    notes: "Первенствующая оценка заменена языком, журналистской ролью и двумя оригинальными названиями произведений.",
  },
  {
    ...
    decision: "corrected",
    notes: "Профиль дополнен языком, вторым автобиографическим произведением и документированной премией.",
  },
  {
    ...
    decision: "corrected",
    notes: "Из-за конфликта авторитетных дат год рождения не публикуется; суперлатив заменён ролями, произведением, премией и членством.",
  },
  {
  ...
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив удалён; первенство премии сохранено по двум официальным источникам и добавлен биографический контекст заключения.",
  },
  {
    ...
    decision: "corrected",
    notes: "Широкая тематическая формула заменена тремя книгами и двумя проверяемыми организационными ролями.",
  },
  {
    ...
    decision: "corrected",
    notes: "Суперлатив заменён полным именем, профессией биолога, жанрами и двумя официальными премиями.",
  },
  {
    ...
    decision: "corrected",
    notes: "Первенствующая оценка удалена; добавлены научная профессия, жанры, направление и дата публикации романа.",
  },
  {
    ...
    decision: "corrected",
    notes: "Непроверенная формула о первой романистке заменена документированным первенством премии, жанрами и тематикой.",
  },
  {
    ...
    decision: "corrected",
    notes: "Список книг заменён более надёжно установленными творческой практикой, политическим заключением и французским периодом.",
  },
  {
    ...
    decision: "corrected",
    notes: "Псевдоним нормализован как Дагон Тая; суперлатив заменён настоящим именем, журналом, движением и документированной премией.",
  },
...
export const writerBiographyFactReviewBatch40: readonly WriterBiographyFactReviewRecord[] =
