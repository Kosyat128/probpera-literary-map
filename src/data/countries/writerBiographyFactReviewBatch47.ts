...
const seeds: readonly ReviewSeed[] = [
  ...
  },
  {
    ...
    reviewedTextRu: "Русский советский писатель, лауреат Нобелевской премии по литературе 1965 года.",
    evidence: [
    ...
    decision: "unchanged",
    notes: "Оба факта исходной карточки подтверждены независимыми институциональными источниками; субъективных утверждений нет.",
  },
  {
    key: "russia:solzhenitsyn",
    originalSha256: "1ec253629066895f9c75ab644defec9a7b7027ba6411ea0ec2de67b5fe5250f5",
    reviewedTextRu: "Русский писатель, историк и общественный деятель, лауреат Нобелевской премии по литературе 1970 года.",
    evidence: [
    ...
    decision: "unchanged",
    notes: "Роли и год Нобелевской премии подтверждены; текст уже нейтрален и фактологически достаточен.",
  },
  {
    key: "russia:tolstoy",
  ...
  },
  {
    ...
    reviewedTextRu: "Марина Цветаева (1892–1941) — русская поэтесса и прозаик. Её первый сборник «Вечерний альбом» вышел в 1910 году, а сборник «Версты» — в 1922 году.",
    evidence: [
      e("Большая российская энциклопедия", "https://bigenc.ru/wiki/%D0%A6%D0%B2%D0%B5%D1%82%D0%B0%D0%B5%D0%B2%D0%B0_%D0%9C%D0%B0%D1%80%D0%B8%D0%BD%D0%B0_%D0%98%D0%B2%D0%B0%D0%BD%D0%BE%D0%B2%D0%BD%D0%B0", "Энциклопедия подтверждает годы жизни Цветаевой, её работу в поэзии и прозе и выход «Вечернего альбома» в 1910 году."),
    ...
    decision: "corrected",
    notes: "Субъективное мировое ранжирование заменено датами, литературными ролями и двумя проверяемыми изданиями.",
  },
  {
    key: "russia:turgenev",
    ...
    evidence: [
      e("Большая российская энциклопедия", "https://bigenc.ru/wiki/%D0%A2%D1%83%D1%80%D0%B3%D0%B5%D0%BD%D0%B5%D0%B2_%D0%98%D0%B2%D0%B0%D0%BD_%D0%A1%D0%B5%D1%80%D0%B3%D0%B5%D0%B5%D0%B2%D0%B8%D1%87", "БРЭ подтверждает даты 1818–1883, литературные роли Тургенева и романы «Дворянское гнездо» и «Отцы и дети»."),
  ...
  },
  {
    ...
    evidence: [
      e("Президентская библиотека имени Б. Н. Ельцина", "https://www.prlib.ru/history/1845699", "Президентская библиотека подтверждает годы жизни Жуковского, его работу поэта и переводчика и публикацию перевода «Одиссеи» в 1849 году."),
      e("Большая российская энциклопедия", "https://bigenc.ru/wiki/%D0%96%D1%83%D0%BA%D0%BE%D0%B2%D1%81%D0%BA%D0%B8%D0%B9_%D0%92%D0%B0%D1%81%D0%B8%D0%BB%D0%B8%D0%B9_%D0%90%D0%BD%D0%B4%D1%80%D0%B5%D0%B5%D0%B2%D0%B8%D1%87", "Энциклопедия независимо подтверждает даты 1783–1852, литературные роли Жуковского и балладу «Светлана»."),
    ],
    decision: "corrected",
