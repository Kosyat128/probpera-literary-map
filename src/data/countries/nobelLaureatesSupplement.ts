...
const laureatesByCountryCode: Record<string, LaureateDraft[]> = {
  ...
  se: [
    ...
    },
    {
      ...
      bio: "Шведский романист-самоучка, чья проза соединяет европейскую историю, античный миф и опыт человека XX века. Нобелевскую премию 1974 года он разделил с Харри Мартинсоном.",
