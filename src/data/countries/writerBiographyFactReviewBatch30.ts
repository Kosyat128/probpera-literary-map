...
const seeds = [
  ...
  },
  {
    ...
    reviewedTextRu: "Пауль Хейзе (1830-1914) - немецкий прозаик, поэт и драматург, который также переводил литературные произведения с итальянского. В 1910 году он получил Нобелевскую премию по литературе.",
    evidence: [
  ...
  },
  {
    ...
    reviewedTextRu: "Рудольф Кристоф Эйкен (1846-1926) - немецкий философ и университетский преподаватель. Он занимал должность профессора Йенского университета, а в 1908 году получил Нобелевскую премию по литературе.",
    evidence: [
  ...
  },
  {
    ...
    reviewedTextRu: "Теодор Моммзен (1817-1903) - немецкий историк античности и правовед, автор многотомного исторического труда «Римская история». В 1902 году он получил Нобелевскую премию по литературе.",
    evidence: [
