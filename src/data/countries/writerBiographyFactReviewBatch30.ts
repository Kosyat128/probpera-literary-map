...
const seeds = [
  {
    ...
    reviewedTextRu: "Гартман фон Ауэ (ок. 1160 — после 1210) — средневерхненемецкий поэт и рыцарь. Он написал куртуазные романы «Эрек» и «Ивейн», а также поэмы «Григорий» и «Бедный Генрих».",
    evidence: [
      ["Deutsche Biographie", "https://www.deutsche-biographie.de/sfz26217.html", "Национальный биографический справочник подтверждает примерные годы жизни, статус рыцаря и поэта, а также авторство четырёх названных произведений."],
    ...
    decision: "corrected",
    notes: "Общее и спорное «один из основателей» заменено конкретными биографическими данными и произведениями. Identity queue: Q75852 согласуется с институциональными источниками; shared country files не изменялись.",
  },
  {
  ...
  },
  {
    ...
    reviewedTextRu: "Джозеф Эфраим Кейсели Хейфорд (1866–1930) — писатель, журналист, юрист и политический деятель Золотого Берега. Он написал роман «Ethiopia Unbound», опубликованный в 1911 году.",
    evidence: [
      ["Inner Temple", "https://www.innertemple.org.uk/who-we-are/history/celebrating-diversity-at-the-bar/joseph-ephraim-casely-hayford/", "Профессиональный архив подтверждает полное имя, годы жизни, юридическую, политическую и литературную деятельность и авторство романа."],
      ...
      ["Encyclopaedia Africana", "https://encyclopaediaafricana.com/hayford-j-e-casely/", "Институциональная энциклопедия подтверждает биографию, политическую деятельность и дату смерти в августе 1930 года."],
    ],
    decision: "corrected",
  ...
  },
  {
    ...
    evidence: [
      ...
      ["University College London", "https://www.ucl.ac.uk/classics/sites/classics/files/odyssey_resource_booklet_x_academus.pdf", "Университетский материал независимо описывает Гомера как традиционно считающегося автором двух древнегреческих эпических поэм."],
    ],
    decision: "unchanged",
  ...
  },
  {
    ...
    evidence: [
      ["Cambridge University Press", "https://www.cambridge.org/core/books/sappho/48E57A3B2331913069102283B4334951", "Академическое издательство подтверждает происхождение Сапфо с Лесбоса, примерный исторический период и лирический характер сохранившихся фрагментов."],
  ...
  },
  {
    ...
    originalSha256: "f8129546620f4eb8b7b70e6e3fd094e800c8c5c52a126a02a6e4b4aade68855c",
