...
function AntiqueContinents(){return <Sphere args={[0.731,128,128]}><meshStandardMaterial color="#5A3B20" transparent opacity={.08} roughness={1}/></Sphere>}
...
export default function LiteraryGlobe({onCountrySelect}:Props){
 return <div style={{width:'100%',height:'560px',background:'radial-gradient(circle,#35205F,#1F103D)',borderRadius:18,overflow:'hidden'}}>
  <Canvas camera={{position:[0,0,3.45],fov:35}}>
   ...
   <AntiqueGlow/><AntiqueGlobe/><ParchmentSurface/><AntiqueContinents/><OldAtlasInk/><Atmosphere/>
