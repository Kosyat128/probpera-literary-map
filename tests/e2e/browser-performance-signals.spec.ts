...
test("mobile homepage stays within the first-load performance budget", async ({
  ...
  await page.addInitScript(() => {
    ...
    const state: PerformanceSignals = {
      ...
      longTaskMax: 0,
      longTaskTotal: 0,
      layoutShiftSupported: supportedEntryTypes.has("layout-shift"),
      lcpSupported: supportedEntryTypes.has("largest-contentful-paint"),
      longTaskSupported: supportedEntryTypes.has("longtask"),
    };
